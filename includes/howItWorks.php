    ...
    <div class="container">
        <fieldset class="fieldset">
            ...
            <p class="text-center"><em> Изпитни тестове, маркетинг проучвания, удоволетвореност на служители или просто
                    забавани анкети и
                    викторини.<br><strong>"МавериК"</strong> е напълно безплатна онлайн платформа, която ще задоволи
                    вашите нужди и ще направи работата Ви по-лесна и ефективна.</em></p>
            <hr>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 col-xs-6 col-sm-6">
                    ...
                    натиснете бутона <strong>ПРЕМИНИ КЪМ ВЪПРОСИТЕ</strong>. <br><br><em>Моля обърнете внимание, че не е
                        задължително да въвеждате инструкции към вашата анкета!</em>
                </div>
                <div class="col-md-6 col-xs-6 col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-6 col-sm-6">
                    ...
                    Създайте динамично неограничен брой въпроси и изберете опции за отговор от падащото меню "+ ТИП".
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-6 col-sm-6">
                    ...
                    Преглеждайте и попълвайте формуляри, ваши и на други потребители за да дадете вашият принос към
            ...
            <div class="row">
                <div class="col-md-6 col-xs-6 col-sm-6">
                    ...
                    Направете бърз и лесен анализ на отговорите на вашите фомуляри, чрез прекрасни графики, които
                    предоставя <strong>"МавериК"</strong>.
                </div>
                <div class="col-md-6 col-xs-6 col-sm-6">
